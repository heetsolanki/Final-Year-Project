...
const DashboardTopCard = ({
  ...
  return (
    <div className="relative rounded-2xl px-4 sm:px-6 md:px-10 lg:px-12 py-6 sm:py-8 md:py-10 mt-4 sm:mt-6 mb-8 sm:mb-10 shadow-md overflow-hidden bg-gradient-to-r from-blue-50 via-white to-blue-50">
      {/* background accent */}
      ...
      <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
        ...
        <div className="flex items-start sm:items-center gap-3 sm:gap-5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1 break-all">{email}</p>

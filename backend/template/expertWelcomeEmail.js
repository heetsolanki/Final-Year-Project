const expertWelcomeEmail = (name, userId) => {
  return `
    ...
    <div style="max-width:600px; margin:auto; background:white; border-radius:10px; overflow:hidden; box-shadow:0 6px 18px rgba(0,0,0,0.08);">
      ...
      <div style="padding:30px;">
        ...
        <p style="color:#4b5563; line-height:1.6;">
          Thank you for joining <b>LawAssist</b> as a <b>Legal Expert</b>.
        </p>

        <p style="color:#4b5563; line-height:1.6;">
          Your expertise will help consumers understand their rights and resolve
          legal concerns more effectively.
        </p>

        <div style="background:#f9fafb; border-left:4px solid #2563eb; padding:15px; margin:25px 0; border-radius:6px;">
          <p style="margin:0; color:#374151;">
            <strong>Your Expert ID:</strong> ${userId}
          </p>
        </div>

        <p style="color:#4b5563; line-height:1.6;">
          Before you start answering queries, please make sure to complete your expert profile.
        </p>

        <ul style="color:#4b5563; line-height:1.8; margin-top:10px;">
          <li>Add your specialization</li>
          <li>Provide your professional experience</li>
...
module.exports = expertWelcomeEmail;
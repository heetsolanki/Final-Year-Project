  ...
  <div style="font-family: Arial, sans-serif; background-color:#f5f7fb; padding:40px 20px;">
    ...
    <div style="max-width:600px; margin:auto; background:white; border-radius:10px; overflow:hidden; box-shadow:0 6px 18px rgba(0,0,0,0.08);">
      ...
      <div style="padding:30px;">
        ...
        <h2 style="color:#111827;">New Consumer Query Posted ⚖️</h2>
        ...
        <p style="color:#4b5563; line-height:1.6;">
          A new consumer query has been submitted on <strong>LawAssist</strong>.
          You can review the query details below and respond through your expert dashboard.
        </p>
        ...
        <p style="color:#111827; font-weight:600;">Query Description:</p>

        <p style="color:#4b5563; line-height:1.6;">
          ${description}
        </p>

        <a href="https://lawassist.vercel.app/expert-dashboard" target="_blank"
...
module.exports = expertQueryNotification;